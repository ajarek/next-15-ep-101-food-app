...
const RecipeUpdateForm = ({
  ...
  const onSubmit: (values: RecipeFormValues) => Promise<void> = async (values) => {
    try {
      ...
      // optionally reset to updated values
      form.reset(values)
  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type='text' placeholder='https://example.com/image.jpg' {...field} />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder='List the ingredients of the dish' className='resize-none' {...field} />
              </FormControl>
        ...
        >
          {form.formState.isSubmitting ? 'Update...' : 'Update Recipe'}
        </Button>
      </form>
